...
let tableElement = table(BorderStyle.Round)(
  ...
  [
    ...
    [
      ul(text("Gegard"), ul()(text("Mousasi"), ul()(text("was a BAD man")))),
      text("Fighter"),
      text("Nasty"),
    ],
  ]
...
let demo = layout(
  ...
  row(
    statusCard(text("API"), text("UP")).border(BorderStyle.Thick),
    statusCard(text("Users"), text("1.2K")),
    statusCard(text("CPU"), text("23%")).border(BorderStyle.Double),
    tableElement,
    section("Pugilists")(
